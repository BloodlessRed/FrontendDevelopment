...
let arrayOfGoods = 
[
  ["Atlas Copco 4220-0982-15 15 meter Cable", 2000, "img/Atlas Cable 1.png"],
  ["Atlas Copco 4220-1007-10 10 meter Extension Cable", 2100, "img/Atlas Cable 2.png"],
  ["Atlas Copco 4200-1010-15 10 meter Extension Cable", 2100, "img/Atlas Cable 3.png"],
  ["Atlas Copco Nutrunner 1", 3400, "img/Atlas ETD inline 1.png"],
  ["Atlas Copco Nutrunner 2", 3240, "img/Atlas ETD inline 2.png"],
  ["Atlas Copco Nutrunner 3", 5000, "img/Atlas ETD inline 3.png"],
]
...
const addItemsToItemList = () => {
  ...
  let mainContainer = document.getElementById("main-container-for-goods");

  arrayOfGoods.forEach(
    (currentValue, index) => {
      let item = `<div class="item">
      <img src="${currentValue[2]}" alt="">
      <div>${currentValue[0]}</div>
      <div>${currentValue[1]}${"$"}</div>
      <button class="readMore" onclick="addCounterToPopUp(); goodsInCart(${index})">Add to cart</button>
      </div>`;

      mainContainer.insertAdjacentHTML("beforeend", item);
    }
  )
}
